...
# Working with ESM-EcmaScript Modules (ESM):
Feacture Flag
Modify in package.json:
  "type": "module" 

Default is "commonjs" (CJS)
...
# .mjs files
specifying modules files.
rename "file.js" files to "file.mjs".
...
https://github.com/digitalinnovationone/formacao-nodejs/tree/main/05-esm-modules
